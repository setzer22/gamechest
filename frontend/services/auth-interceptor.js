...
angular.module('GameChestApp').factory('authInterceptor', ['$q', '$window', '$injector', function ($q, $window, $injector) {
    return {
...
angular.module('GameChestApp').config(['$httpProvider', function ($httpProvider) {
